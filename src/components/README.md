...
зв'язку: добре, нейтрально і погано. Крок 1
...
Інтерфейс може мати такий вигляд. component preview Крок 2
...
допоміжні методи onCountTotalFeedback() і countonPositiveFeedbackPercentage(),
які підраховують ці значення, ґрунтуючись на даних у стані (обчислювані дані).
component preview Крок 3
